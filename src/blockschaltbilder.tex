...
\newcommand{\PGlied}[5][]{ %
  \begin{scope}[thick, #1]
    ...
    \node[above, align = left, text width = #4] at (#2.north) {#5};
    % Block
    \draw (#2.north east) rectangle (#2.south west);
    % Horizontale Linie
...
\newcommand{\TZGlied}[6][]{ %
  \begin{scope}[thick, #1]
    ...
    \node[above, align = center, text width = #4] at (#2.north) {\mbox{#5} \hfill \mbox{#6}};
    % Block
    \draw (#2.north east) rectangle (#2.south west);
    % Totzeit-Eck
